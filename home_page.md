...
> *"在灰色的世界中追寻纯粹的白色或黑色，也只是坐井观天吧。"*

...row-start horizontal=spacedBy(12)
...button-text text="📋 复制" event="copy{在灰色的世界中追寻纯粹的白色或黑色，也只是坐井观天吧。}"
...row-end
...column-end
...card-end
...
...row-end
...row-start horizontal=spacedBy(8)
...button-filled-tonal text="📖 Minecraft Wiki" event="url{https://minecraft.wiki/Java_Edition_block_render_history%2FCopper_Bars}" weight=(1)
...
📖 **Wiki 推荐**：[Java Edition block render history/Copper Bars](https://minecraft.wiki/Java_Edition_block_render_history%2FCopper_Bars)

⏰ 更新时间：2026-07-02 13:45:33
