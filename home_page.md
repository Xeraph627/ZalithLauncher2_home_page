...
...button-text text="📋 复制" event="copy{如果你热爱生活就不要浪费时间，因为时间组成了生活。}"
...row-end
...column-end
...card-end
...
...row-end
...row-start horizontal=spacedBy(8)
...button-filled-tonal text="📖 Minecraft Wiki" event="url{https://minecraft.wiki/Java_Edition_mob_render_history%2FPig}" weight=(1)
...
📖 **Wiki 推荐**：[Java Edition mob render history/Pig](https://minecraft.wiki/Java_Edition_mob_render_history%2FPig)

⏰ 更新时间：2026-07-11 13:04:29
