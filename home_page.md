...
...button-text text="📋 复制" event="copy{前天是小兔子,昨天是小鹿,今天是你}"
...row-end
...column-end
...card-end
...
...row-end
...row-start horizontal=spacedBy(8)
...button-filled-tonal text="📖 Minecraft Wiki" event="url{https://minecraft.wiki/Bedrock_Edition_block_render_history%2FQuartz_Bricks}" weight=(1)
...
📖 **Wiki 推荐**：[Bedrock Edition block render history/Quartz Bricks](https://minecraft.wiki/Bedrock_Edition_block_render_history%2FQuartz_Bricks)

⏰ 更新时间：2026-08-02 02:08:28
