...
...image url="// ============================================
// 🎮 Zalith Launcher 2 - 全自动更新主页
// 生成时间：2026-05-10 15:00
// 数据来源：Bing | 一言 | MC百科 | Mojang | CurseForge | Modrinth
// ============================================
...
...column-start vertical=spacedBy(6) horizontal=Start
- [工业2](https://www.mcmod.cn/class/2.html) - 经典科技模组
- [暮色森林](https://www.mcmod.cn/class/19.html) - 冒险维度模组
- [应用能源2](https://www.mcmod.cn/class/184.html) - 存储网络模组
- [热力膨胀](https://www.mcmod.cn/class/31.html) - 科技模组
- [神秘时代6](https://www.mcmod.cn/class/463.html) - 魔法模组
- [匠魂](https://www.mcmod.cn/class/36.html) - 工具模组
...
...column-start vertical=spacedBy(6) horizontal=Start
- [Just Enough Items (JEI)](https://www.curseforge.com/minecraft/mcmods/jei) - 物品管理器
- [JourneyMap](https://www.curseforge.com/minecraft/mcmods/journeymap) - 实时地图
- [Iron Chests](https://www.curseforge.com/minecraft/mcmods/iron-chests) - 更多箱子
- [Biomes O' Plenty](https://www.curseforge.com/minecraft/mcmods/biomes-o-plenty) - 更多生物群系
- [Tinkers' Construct](https://www.curseforge.com/minecraft/mcmods/tinkers-construct) - 匠魂
...
...column-start vertical=spacedBy(6) horizontal=Start
- [Sodium](https://modrinth.com/mod/sodium) - 高性能渲染引擎
- [Iris](https://modrinth.com/mod/iris) - 现代光影加载器
- [Fabric API](https://modrinth.com/mod/fabric-api) - Fabric 核心 API
- [Lithium](https://modrinth.com/mod/lithium) - 游戏逻辑优化
- [Phosphor](https://modrinth.com/mod/phosphor) - 光照引擎优化
...
—— 昌平线南延开通活动标语 · 北京地铁
        ...
        ...row-start horizontal=spacedBy(12)
            ...button-filled-tonal text="🔄 刷新" event="url {https://v1.hitokoto.cn/}" width=100dp
            ...button-text text="📋 复制" event="copy {行之所致，遍地书香。}"
        ...row-end
    ...column-end
...card-end
