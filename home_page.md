...
> *"谁不是在崩溃的边缘苦求着希望，想要用魔法解开生活的惆怅。"*

...row-start horizontal=spacedBy(12)
...button-text text="📋 复制" event="copy{谁不是在崩溃的边缘苦求着希望，想要用魔法解开生活的惆怅。}"
...row-end
...column-end
...card-end
...
...row-end
...row-start horizontal=spacedBy(8)
...button-filled-tonal text="📖 Minecraft Wiki" event="url{https://minecraft.wiki/Java_Edition_block_render_history%2FAcacia_Wood}" weight=(1)
...
📖 **Wiki 推荐**：[Java Edition block render history/Acacia Wood](https://minecraft.wiki/Java_Edition_block_render_history%2FAcacia_Wood)

⏰ 更新时间：2026-07-16 02:01:55
