...
...button-text text="📋 复制" event="copy{付出就会有收获，这收获不一定就是结果，也可以是经过。}"
...row-end
...column-end
...card-end
...
...row-end
...row-start horizontal=spacedBy(8)
...button-filled-tonal text="📖 Minecraft Wiki" event="url{https://minecraft.wiki/Dripstone_(feature)}" weight=(1)
...
📖 **Wiki 推荐**：[Dripstone (feature)](https://minecraft.wiki/Dripstone_(feature))

⏰ 更新时间：2026-08-05 01:55:36
