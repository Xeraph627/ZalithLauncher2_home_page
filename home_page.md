...
> *"奋斗的目标就是为了躺平，就是为了过上不被闹钟叫醒的日子。"*

...row-start horizontal=spacedBy(12)
...button-text text="📋 复制" event="copy{奋斗的目标就是为了躺平，就是为了过上不被闹钟叫醒的日子。}"
...row-end
...column-end
...card-end
...
...row-end
...row-start horizontal=spacedBy(8)
...button-filled-tonal text="📖 Minecraft Wiki" event="url{https://minecraft.wiki/Java_Edition_1.8%2FDevelopment_versions}" weight=(1)
...
📖 **Wiki 推荐**：[Java Edition 1.8/Development versions](https://minecraft.wiki/Java_Edition_1.8%2FDevelopment_versions)

⏰ 更新时间：2026-08-03 02:10:51
