...
...button-text text="📋 复制" event="copy{不能逃避，不能逃避，不能逃避，不能逃避……}"
...row-end
...column-end
...card-end
...
...row-end
...row-start horizontal=spacedBy(8)
...button-filled-tonal text="📖 Minecraft Wiki" event="url{https://minecraft.wiki/Bastion_Remnant%2FStructure%2FBlueprints%2FBridge}" weight=(1)
...
📖 **Wiki 推荐**：[Bastion Remnant/Structure/Blueprints/Bridge](https://minecraft.wiki/Bastion_Remnant%2FStructure%2FBlueprints%2FBridge)

⏰ 更新时间：2026-07-08 02:05:58
