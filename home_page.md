...
...button-text text="📋 复制" event="copy{无奈夜长人不寐，数声和月到帘栊。}"
...row-end
...column-end
...card-end
...
...row-end
...row-start horizontal=spacedBy(8)
...button-filled-tonal text="📖 Minecraft Wiki" event="url{https://minecraft.wiki/Java_Edition_item_texture_history%2FOrange_Bundle}" weight=(1)
...
📖 **Wiki 推荐**：[Java Edition item texture history/Orange Bundle](https://minecraft.wiki/Java_Edition_item_texture_history%2FOrange_Bundle)

⏰ 更新时间：2026-08-07 12:48:18
