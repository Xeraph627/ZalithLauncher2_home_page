...
...button-text text="📋 复制" event="copy{盖牌认输永远不在选择之列。}"
...row-end
...column-end
...card-end
...
...row-end
...row-start horizontal=spacedBy(8)
...button-filled-tonal text="📖 Minecraft Wiki" event="url{https://minecraft.wiki/Minecraft_Blast_0.11.2}" weight=(1)
...
📖 **Wiki 推荐**：[Minecraft Blast 0.11.2](https://minecraft.wiki/Minecraft_Blast_0.11.2)

⏰ 更新时间：2026-07-18 13:01:58
