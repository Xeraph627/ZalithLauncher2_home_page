...
> *"但凡缺少一点痛苦和温暖，都无法成就今天的我。"*

...row-start horizontal=spacedBy(12)
...button-text text="📋 复制" event="copy{但凡缺少一点痛苦和温暖，都无法成就今天的我。}"
...row-end
...column-end
...card-end
...
...row-end
...row-start horizontal=spacedBy(8)
...button-filled-tonal text="📖 Minecraft Wiki" event="url{https://minecraft.wiki/Bedrock_Edition_mob_render_history%2FSpider_Jockey}" weight=(1)
...
📖 **Wiki 推荐**：[Bedrock Edition mob render history/Spider Jockey](https://minecraft.wiki/Bedrock_Edition_mob_render_history%2FSpider_Jockey)

⏰ 更新时间：2026-08-02 06:28:04
