...
async function fetchModrinthLatest() {
 ...
 return [
 { name: 'Sodium', slug: 'sodium', url: 'https://modrinth.com/mod/sodium', description: '高性能渲染引擎，大幅提升FPS', downloads: '15M+', iconUrl: 'https://cdn.modrinth.com/data/AANobbMI/icon.png', author: 'JellySquid', created: '2020-05-01' },
 { name: 'Iris', slug: 'iris', url: 'https://modrinth.com/mod/iris', description: '现代光影加载器', downloads: '8M+', iconUrl: 'https://cdn.modrinth.com/data/YL57xq9U/icon.png', author: 'Iris Team', created: '2021-04-15' },
 { name: 'Fabric API', slug: 'fabric-api', url: 'https://modrinth.com/mod/fabric-api', description: 'Fabric 模组加载器核心 API', downloads: '20M+', iconUrl: 'https://cdn.modrinth.com/data/P7dR8mSH/icon.png', author: 'FabricMC', created: '2018-12-10' }
 ];
 }
}
...
async function generateHomePage() {
 ...
 // ====== 修复：构建符合 Zalith 语法的 Modrinth 列表 ======
 // 关键修复点：
 // 1. 不使用缩进（组件行顶格写）
 // 2. 描述文本作为独立 Markdown 段落，放在组件行之后
 // 3. 每个模组之间用空行分隔
...
📥 ${mod.downloads} | 👤 ${mod.author} | 📅 ${mod.created}
